...
namespace kubaapi.Migrations
{
    ...
    [Migration("20190420130318_Initial")]
            ...
            modelBuilder.Entity("rl_contract.Models.Anamnese", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountOfPositivAnswers = -1, Date = new DateTime(2019, 4, 20, 15, 3, 18, 379, DateTimeKind.Local), Name = "Anamnese (Fragebogen / Kinder)", PatientId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("rl_contract.Models.Testung", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2019, 4, 20, 15, 3, 18, 368, DateTimeKind.Local), Name = "Erste Testung", PatientId = 1 }
                    );
                });
