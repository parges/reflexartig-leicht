...
namespace kubaapi.Migrations
{
    ...
    [Migration("20190509161602_addFiles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rl_contract.Models.Anamnese", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CountOfPositivAnswers = -1, Date = new DateTime(2019, 5, 9, 18, 16, 2, 263, DateTimeKind.Local), Name = "Anamnese (Fragebogen / Kinder)", PatientId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("rl_contract.Models.FileData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("rl_contract.Models.Testung", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2019, 5, 9, 18, 16, 2, 263, DateTimeKind.Local), Name = "Erste Testung", PatientId = 1 }
                    );
                });
